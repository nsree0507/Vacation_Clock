...
const stateModules = import.meta.glob('../*.{jpg,jpeg,png,webp}', { eager: true, import: 'default' });
...
export const northStateHeroImages = {
  ...
  5: hero('uttarakhand'),
  6: hero('jammu and kashmir', 'jammukashmir', 'kashmir'),
  7: hero('rajasthan'),
};
...
export const stateGalleryImages = {
  ...
  6: gallery('jammu and kashmir', 'kashmir', 'nature'),
